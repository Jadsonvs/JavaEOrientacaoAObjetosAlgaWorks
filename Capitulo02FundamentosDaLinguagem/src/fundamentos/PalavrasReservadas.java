...
Muita gente imagina que para estudar a linguagem Java tem que aprender (decorar) todas as palavras reservadas, pois temos que usá-las de forma que não causem erros em nossas
programações.

 

O que precisamos entender mesmo é como são divididas e quando vamos usá-las, elas são divididas em modificadores de acesso, modificadores de classe, método e variável,
controle de fluxo, tratamento de erros, controle de pacotes, primitivas, palavras-chaves de variáveis, void para retornos e também as palavras reservadas não utilizadas.
...
Claro que muitas destas palavras vocês já conhecem, pois imaginamos que sabemos utilizar um if ou um while ou para quem conhece o while nada mais é do que um for irrustido, 
já vimos algumas delas como public, protected, private, final e ainda vamos ver todas elas explicando suas peculiaridades. Então até a próxima.
	 
	         
	LINK: https://www.devmedia.com.br/o-que-significa-cada-palavra-reservada/8320
